...
?>
<div id="cw-sticky-bar" class="cw-sticky-bar cw-template-2 cw-position-<?php echo esc_attr($this->settings['position']); ?>" style="<?php echo esc_attr($style_vars); ?>" aria-live="polite">
    <div class="cw-sticky-inner">
        <div class="cw-message-wrap">
            <span class="cw-badge">HOT DEAL</span>
