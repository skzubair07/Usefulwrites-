...
<div id="cw-eib-overlay" class="cw-eib-overlay" aria-hidden="true">
    <div class="cw-eib-popup cw-eib-template-two" role="dialog" aria-modal="true" aria-labelledby="cw-eib-title-two">
        <button class="cw-eib-close" type="button" aria-label="Close popup">×</button>
        <div class="cw-eib-grid">
            <div class="cw-eib-col-content">
                <h2 id="cw-eib-title-two"><?php echo esc_html( $settings['headline'] ); ?></h2>
            ...
            <div class="cw-eib-col-action">
                <form class="cw-eib-form" novalidate>
                    <?php if ( ! empty( $settings['show_name'] ) ) : ?><input type="text" name="name" placeholder="Name" autocomplete="name"><?php endif; ?>
